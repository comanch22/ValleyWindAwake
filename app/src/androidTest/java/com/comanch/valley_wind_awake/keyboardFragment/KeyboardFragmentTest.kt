...
class KeyboardFragmentTest {
    ...
    fun check_addItem() {
        ...
        try {
            ...
            assertEquals("$actualDate 23:59", specialDateStr)
    ...
    fun check_stateAfterRotation() {
        ...
        (keyFragment as KeyboardFragment).activity?.requestedOrientation = ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE
        Thread.sleep(2000)
